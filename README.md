...
**Package version:** `0.6.2` (semantic bio stub + content-binding; builds on 0.6.0 connectors + no-bypass + bio bus).
...
**Full-system roadmap:** [`docs/FULL_GOVERNANCE_ROADMAP.md`](docs/FULL_GOVERNANCE_ROADMAP.md) (0.6.2 semantic stub; 0.6.1 content-binding; 0.6.0 connectors + no-bypass + bio bus; remaining: tool/agent deepen, tenancy/KMS).
