...
| `GOVERNANCE_REQUIRE_PERSISTED_KEY` | unset/`0` | `1` = refuse ephemeral / missing PEM; in **multi-tenant** also refuse shared default PEM fallback (each tenant needs its own key) |
