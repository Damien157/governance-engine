...
- **REVIEW has no timeout / auto-promotion.** Each check is stateless; unresolved REVIEW holds as REVIEW on re-check until inputs change or a human resolves outside the gate (never delayed ALLOW).
